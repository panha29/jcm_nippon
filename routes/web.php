...
Route::group(['prefix' => 'User',  'middleware' => 'auth'], function()
{
    Route::get('/Dashboard', function() {
        ...
        $Green = DB::table('colorpalette')->where('colorpalette_category','=','Green')->take(10)->get();
        $Red = DB::table('colorpalette')->where('colorpalette_category','=','Red')->take(10)->get();
        $Yellow = DB::table('colorpalette')->where('colorpalette_category','=','Yellow')->take(10)->get();
        $Orange = DB::table('colorpalette')->where('colorpalette_category','=','Orange')->take(10)->get();
        $Blue = DB::table('colorpalette')->where('colorpalette_category','=','Blue')->take(10)->get();
        $Purple = DB::table('colorpalette')->where('colorpalette_category','=','Purple')->take(10)->get();
        $Grey = DB::table('colorpalette')->where('colorpalette_category','=','Grey')->take(10)->get();
        $Neutral = DB::table('colorpalette')->where('colorpalette_category','=','Neutral')->take(10)->get();
        $GreenBlue = DB::table('colorpalette')->where('colorpalette_category','=','GreenBlue')->take(10)->get();
        $OffWhite = DB::table('colorpalette')->where('colorpalette_category','=','OffWhite')->take(10)->get();

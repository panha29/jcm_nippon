    ...
    k.prototype = {
        ...
        _process_options: function(b) {
            ...
            q[f] || ((f = f.split('-')[0]), q[f] || (f = o.language)),
                ...
                (e.startView = Math.max(this.o.minViewMode, Math.min(this.o.maxViewMode, e.startView))), !0 !== e.multidate && ((e.multidate = Number(e.multidate) || !1), !1 !== e.multidate && (e.multidate = Math.max(0, e.multidate))),
        ...
        update: function() {
            ...
            return (
                ...
                this.dates.length && String(b) !== String(this.dates) && d && (this._trigger('changeDate'), this.element.change()), !this.dates.length && b.length && (this._trigger('clearDate'), this.element.change()),
                this.fill(),
                this
            );
        },
        fillDow: function() {
            if (this.o.showWeekDays) {
                ...
                for (this.o.calendarWeeks && (c += '<th class="cw">&#160;</th>'); b < this.o.weekStart + 7;)
                    (c += '<th class="dow'), -1 !== a.inArray(b, this.o.daysOfWeekDisabled) && (c += ' disabled'),
        ...
        getClassNames: function(b) {
            ...
            return (
                ...
                this.range &&
                (b > this.range[0] && b < this.range[this.range.length - 1] && c.push('range'), -1 !== a.inArray(b.valueOf(), this.range) && c.push('selected'),
        ...
        _fill_yearsView: function(c, d, e, f, g, h, i) {
            for (
                ...
                (j = [d]),
                (k = null),
                t === p - n ? j.push('old') : t === q + n && j.push('new'), -1 !== a.inArray(t, s) && j.push('active'),
                (t < g || t > h) && j.push('disabled'),
                t === r && j.push('focused'),
                i !== a.noop &&
                ((l = i(new Date(t, 0, 1))),
                    l === b ? (l = {}) : 'boolean' == typeof l ? (l = { enabled: l }) : 'string' == typeof l && (l = { classes: l }), !1 === l.enabled && j.push('disabled'),
            ...
            if (!isNaN(h) && !isNaN(i)) {
                ...
                for (var x, y, z = []; u.valueOf() < w;) {
                    ...
                    this.o.beforeShowDay !== a.noop &&
                        ((f = this.o.beforeShowDay(this._utc_to_local(u))),
                            f === b ? (f = {}) : 'boolean' == typeof f ? (f = { enabled: f }) : 'string' == typeof f && (f = { classes: f }), !1 === f.enabled && y.push('disabled'),
                ...
                if (
                    ...
                    a.each(G, function(c, d) {
                        ...
                        f === b ? (f = {}) : 'boolean' == typeof f ? (f = { enabled: f }) : 'string' == typeof f && (f = { classes: f }), !1 !== f.enabled || a(d).hasClass('disabled') || a(d).addClass('disabled'),

...
(function(a) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(b) { return a(b, window, document) }) : "object" === typeof exports ? module.exports = function(b, c) { b || (b = window);
    ...
    d.ext.renderer.pageButton.semanticUI = function(f, l, B, C, m, u) {
        var v = new d.Api(f),
            ...
            h, k, w = 0,
            z = function(q, x) {
                var y, F = function(p) { p.preventDefault();
                ...
                for (y = x.length; r < y; r++) {
                    ...
                    if (Array.isArray(g)) z(q, g);
                        ...
                        }).html(h).appendTo(q), f.oApi._fnBindAction(t, { action: g }, F), w++)
                    }
                }
            };
        try { var A = a(l).find(c.activeElement).data("dt-idx") } catch (q) {}

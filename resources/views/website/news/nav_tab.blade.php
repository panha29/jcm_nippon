...
<div class="small-screen">
    <div style="margin:auto; display:block;">
        <ul class="nav nav-tabs-title nav-tabs-line-title responsive-tabs center-nav" id="lineTitleTabsContainer" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" data-bs-toggle="tab" href="#newsTab" role="tab" style="font-size: 16px" aria-selected="true" draggable="false"><b>NEWS</b></a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" data-bs-toggle="tab" href="#mediaTab" role="tab" style="font-size: 16px" aria-selected="false" draggable="false"><b>MEADIA</b></a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" data-bs-toggle="tab" href="#careerTab" role="tab" style="font-size: 16px" aria-selected="false" draggable="false"><b>CAREER</b></a>
            </li>
            {{-- <li class="nav-item dropdown ms-auto pe-0 d-none responsive-tab-dropdown">
                <a class="btn btn-icon btn-icon-only btn-background pt-0 bg-transparent pe-0" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i data-acorn-icon="more-horizontal"></i>
        ...
        <div class="tab-content mb-7 mt-7">
            <div class="tab-pane fade active show" id="newsTab" role="tabpanel" style="text-align: center">
                <div class="center-view">
                    @foreach ($data as $item)
                        <div class="mt-5"  >
                            <a href="">
                                <img src="{{url('img/company_news/'.$item->news_image)}}" class="" alt="" style="width:100%">
                            </a>
                            <h5 class="mt-3" style="text-align: left">{{$item->news_date}}</h5>
                            <h5 class="mt-2" style="width: 330px; text-align:left; line-height:20px"><b>{{$item->news_title}}</b> <br> <a href="">read more</a></h5>
                        </div>
                    @endforeach
                </div>
            </div>
            <div class="tab-pane fade" id="mediaTab" role="tabpanel" >
                <div class="center-view">
                    @foreach ($media as $item)
                    <div class=""  >
                            <video class="player"  style="width:100%">
                                <source src="{{asset('img/company_media/'.$item->media_image)}}" type="video/mp4" style="" />
                            </video>
                        <h5 class="mt-3" style="text-align: left">{{$item->media_date}}</h5>
                        <h5 class="mt-2" style="width: 330px; text-align:left; line-height:20px"><b>{{$item->media_title}}</b> <br> <a href="">read more</a></h5>
                    </div>
                    @endforeach
                </div>
            </div>
            <div class="tab-pane fade" id="careerTab" role="tabpanel" >

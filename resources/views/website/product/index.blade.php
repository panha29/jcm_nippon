@php
    ...
    $title = 'Product';
    $description = 'Product';
    $breadcrumbs = ["/"=>"Home","/location"=>"Product"]
@endphp
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 g-2 mb-5">
        ...
        <div class="col mt-5">
            <div class="card h-100">
                <div class="background-img hover-img-scale-up">
                    <img src="{{ url('img/product/company_product/'.$item->product_image) }}" class="card-img-top sh-22 scale" alt="nippon paint cambodia" style="width: 50%;display:block ;margin:auto" draggable="false"/>
                </div>
                <div class="card-body pb-2">
                    <div class="h5 mb-0 d-flex">
                        <span class="clamp-line sh-4" data-line="2">{{$item->product_name}}</span>
                    </div>
                </div>
            </div>
        </div>

            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-body text-center">
                        ...
                        <a href="#" class="body-link"><h2>{{$user->name}}</h2></a>
                        ...
                        <div class="row g-0 align-items-center mb-1">
                            ...
                            <div class="col ps-3">
                                <div class="row g-0">
                                    ...
                                    <div class="col-auto">
                                        <div class="sh-4 d-flex align-items-center text-alternate"><b></b></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row g-0 align-items-center mb-1">
                            ...
                            <div class="col ps-3">
                                <div class="row g-0">
                                    ...
                                    <div class="col-auto">
                                        <div class="sh-4 d-flex align-items-center text-alternate">{{$user->email}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row g-0 align-items-center">
                            ...
                            <div class="col ps-3">
                                <div class="row g-0">
                                    ...
                                    <div class="col-auto">
                                        <div class="sh-4 d-flex align-items-center text-alternate">(+855){{$user->phone}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>

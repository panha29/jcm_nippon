                    ...
                    <tbody id="tbody">
                        ...
                        @foreach ($project as $item)
                            ...
                            <tr>
                                ...
                                <td class="pjlabelkh-height" style="text-align: center">{{$item->quantity}}</td>
                                <td class="pjlabelkh-height" style="text-align: center">{{$item->order_date}} <br> {{$item->order_time}}</td>
                                <td class="pjlabelkh-height" style="text-align: center">{{$item->process_start_date}} <br> {{$item->process_start_time}} </td>
                                <td class="pjlabelkh-height" style="text-align: center">{{$item->testing_date}} <br> {{$item->testing_time}}</td>
                                <td class="pjlabelkh-height" style="text-align: center">{{$item->pickup_date}} <br> {{$item->pickup_time}} </td>
                                <td class="pjlabelkh-height" style="text-align: center">{{$item->end_date}}</td>
                                <td class="pjlabelkh-height" style="text-align: center">{{$item->delay_date}}</td>
                                <td class="col-2 pjlabelkh pjlabelkh-height" style="text-align:left; font-size: 12px !important" >{{$item->note}}</td>
                                <td class="col-2 pjlabelkh pjlabelkh-height" style="text-align:left; font-size: 12px !important" >{{$item->problem}}</td>
                                <td>
                                    {{-- <div class="progress">

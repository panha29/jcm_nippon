    ...
    <div class="">
        ...
        <div class="row mb-2">
            ...
            {{-- <div class="col">
                ...
                <a href="Den/History" class="btn btn-success" draggable="false">History</a>
            </div> --}}
                    ...
                    <div class="row mb-2">
                        <div class="col-md-2 custom_width" style="width:10.666%;!important">
                            <div class="d-inline-block float-md-start me-1 mb-2 search-input-container shadow" style="background-color: #e7e7e7">
                                <input class="form-control" placeholder="Start" id="min" name="min" autocomplete="off" />
                                <span class="search-magnifier-icon">
                                    <i data-acorn-icon="search"></i>
                                </span>
                            </div>
                        ...
                        <div class="col-md-2 custom_width" style="width:10.666%;!important">
                            <div class="d-inline-block float-md-start me-1 mb-2 search-input-container shadow" style="background-color: #e7e7e7">
                                <input class="form-control" placeholder="End" id="max" name="max" autocomplete="off" />
                                <span class="search-magnifier-icon">
                                    <i data-acorn-icon="search"></i>
                                </span>
                            </div>
                    ...
                    <tbody id="tbody">
                        ...
                        @foreach ($project as $item)
                            ...
                            <tr >
                                ...
                                @include('admin-view.calendar.delete_project_den_modal')

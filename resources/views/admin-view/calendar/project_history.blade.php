@php
    $html_tag_data = [];
    $title = 'Project HISTORY List';
    $description= 'Ecommerce Project HISTORY List Page'
    @endphp
...
<script>
    ...
    $("#datepickersdd{{$loop->index}}, #datepickeredd{{$loop->index}},#datepickeror{{$loop->index}},#datepickerspd{{$loop->index}},#datepickerpd{{$loop->index}},#datepickertd{{$loop->index}},#datepickersd{{$loop->index}},#datepickerdd{{$loop->index}}").datepicker();
    @endforeach
</script>
                ...
                <table id="filter_pj" class="stripe" style="width: 100%">
                    ...
                    <tbody id="tbody">
                        ...
                        <tr >
                            ...
                            <td>
                                <label for="progress"> {{$item->progress}}% <progress max="100" value="{{$item->progress}}" style="--p:{{$item->progress}}%"></progress></label>
                            </td>
                            {{-- <td></td> --}}
                            <td>

        ...
        <div class="modal-body">
            <form method="POST" action="/Admin/Calendar/Edit/Project/{{$item->id}}/True" id="form" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-floating mb-3 progress-modal">
                            ...
                            <input autocomplete="off" class="form-control" id="head_tailor" placeholder="មេជាង" name="head_tailor" value="{{$item['head_tailor']}}">
                            <label class="pjlabelkh" for="head_tailor">មេជាង</label>
                        </div>
                    </div>
                    <div class="col">
                        <div id="mydiv" class="form-floating mb-3 progress-modal">
                            <input autocomplete="off" id="tailor" class="form-control" placeholder="កូនជាង" name="tailor" id="1" value="{{$item['tailor']}}">
                            <label class="pjlabelkh" for="tailor">កូនជាង</label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-floating mb-3 progress-modal">
                            <input autocomplete="off" class="form-control" placeholder="ចំនួន" id="quantity" name="quantity" value="{{$item['quantity']}}">

<div class="row">
    ...
    <input type="text" name="project_de" value="not_yet" hidden>
    <input type="text" name="project_den" value="{{$item['project_den']}}" hidden>
    <div class="col" hidden>

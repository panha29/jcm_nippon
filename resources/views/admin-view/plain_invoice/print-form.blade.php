    ...
    border-color:  black!important;
        ...
        <body>
			<div class="cs-invoice_btns cs-hide_print">
                ...
                <a href="/Orders/List" class="cs-invoice_btn cs-color1 print print-btn" style="margin-top: 50px">
				...
				<article>
						...
						<tbody>
                            <?php if ($item->product1 != "") { ?>
								<tr>
									...
									<td style="text-align: center" class="labelkh1"> <span class="text-small"></span></td>
					...
					<table class="balance">
                        ...
                        <tr>
							<th class="labelkh1"><span>សរុប/Total</span></th>
							<td><span></span><span data-prefix> $</span></td>
						</tr>
						<tr>
							<th class="labelkh1"><span>Discount</span></th>
							<td><span></span><span data-prefix> $</span></td>
						...
						<tr>
							<th class="labelkh1"><span>កក់មុន/Deposit</span></th>
							<td><span contenteditable="true"></span><span data-prefix>&nbsp;$</span></td>
						</tr>
						<tr>
							<th class="labelkh1"><span>នៅខ្វះ/Balance</span></th>
							<td><span contenteditable="true"></span><span data-prefix>&nbsp;$</span></td>

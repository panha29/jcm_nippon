            ...
            <table id="filter_table" class="ui celled table" style="width:100%">
                ...
                <tbody id="tbody">
                    ...
                    @foreach ($item as $data)
                        @php
                            if ( $data->issued_paid == 'PAID'):
                                $color = '#dfdfdf;';
                            elseif ( $data->issued_paid == ''):
                            $color = 'white';
                            else:
                            $color = 'white';
                            endif;
                    ...
                    <tr class="" style="background-color: {{$color}}">
                        ...
                        <td class="col-1" style="text-align: left"><b>$ {{number_format($data->balance,2)}}</b></td>
                        ...
                        <td class="col-1 order_list_mobile" style="text-align: center;">
                            <a draggable="false" class="print btn btn-outline-primary" style="display:inline-grid" href="Invoice/{{$data->id}}">
                                <i data-acorn-icon="check" data-acorn-size="18"></i>
                            </a>
                            {{-- <a draggable="false" class="btn btn-warning" href="destroy/{{$data->id}}">

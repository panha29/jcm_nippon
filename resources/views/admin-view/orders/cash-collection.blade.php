@php
    ...
    $description= 'Ecommerce Cash Collection Page';
@endphp
            ...
            <table id="filter_table" class="ui celled table" style="width:100%">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="order_list_mobile">ISSUED DATE</th>
                        <th>BALANCE</th>
                        <th>PAYMENT VIA</th>
                        <th></th>
                    </tr>
                ...
                <tbody id="tbody">
                    ...
                    <tr>
                        ...
                        <td class="col-1 order_list_mobile" style="text-align: center">{{$data->issued_date}}</td>
                        <td class="col-1" style="text-align: center"><b>{{$data->balance}}</b></td>
                        <td class="col-1" style="text-align: center"><b>{{$data->issued_payment_via}}</b></td>
                        <td class="col-1" style="text-align: center">
                            <a draggable="false" class="print btn btn-primary" style="display:inline-grid" target="_blank" href="Receipt/{{$data->id}}">
                                <i data-acorn-icon="eye" data-acorn-size="18"></i>
                            </a>
                            <a draggable="false" class="btn btn-warning" href="destroy/invoice/{{$data->id}}">

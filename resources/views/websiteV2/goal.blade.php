            ...
            <div class="col col-12 col-xl-6 text-center p-0 mb-30">
                <div class="title-module">
                    <div class="ld-fancy-heading relative animation-element">
                        <h2 class="ld-fh-element inline-block relative mb-0/5em">Our Goal</h2>
                    </div>
                    <div class="ld-fancy-heading relative animation-element">
                        <p class="ld-fh-element inline-block relative mb-0/5em text-20 leading-1/7em">Our Company services starts and ends with a best in class experience strategy and quality of the product.</p>
                    </div>
                </div>
            </div>

...
<div id="lqd-contents-wrap" class="mobile-display">
        ...
        <div class="container titlebar-container">
            <div class="row titlebar-container justify-center">
                <div class="col titlebar-col col-xl-6 col-lg-8 col-12 text-center text-gray-400">
                    <h4 class="uppercase title-h6">Nippon Epoxy EA4</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="" >
        <img src="{{ url('webv2/images/product/EpoxyEA4.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint" class="mobile-center">
        <a href="/webv2/coating/ea4-kh.pdf" download="Nippon Epoxy EA4" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (KHM)
        </a>
        <a href="/webv2/coating/ea4.pdf" download="Nippon Epoxy EA4" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (ENG)
        </a>
    </div>
    <div class="mobile-center" style="width: 350px;">
        <h3 class="mt-50" >Product Information</h3>
        <h6 style="line-height:25px; text-align: justify;">NIPPON EA4 is a two-pack, high gloss Amine-Adduct Epoxy coating for use on steel, concrete, plaster, brick and
            most types of building boards and blocks where chemical, oil and abrasion resistant coating is required. It is
            recommended for non-immersion services. Non-skid quality available upon request.
            voe content is < 350 g/L.
        </h6>
        ...
        <h4 class="mt-50">2.Application of Nippon Epoxy EA4</h4>
        <ul style="line-height:25px">
            <li>Masonry.</li>
            <li>Cement.</li>
            <li>Concrete.</li>

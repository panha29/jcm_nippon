...
<div id="lqd-contents-wrap" class="mobile-display">
        ...
        <div class="container titlebar-container">
            <div class="row titlebar-container justify-center">
                <div class="col titlebar-col col-xl-6 col-lg-8 col-12 text-center text-gray-400">
                    <h4 class="uppercase title-h6">Nippon Vinilex 5000</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="" >
        <img src="{{ url('webv2/images/product/vinilex5000.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint" class="mobile-center">
        <a href="/webv2/primer-sealer/vinilex5000-sealer-kh.pdf" download="Nippon Vinilex 5000" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (KHM)
        </a>
        <a href="/webv2/primer-sealer/vinilex5000-sealer.pdf" download="Nippon Vinilex 5000" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (ENG)
        </a>
    </div>
    <div class="mobile-center" style="width: 350px;">
        <h3 class="mt-50" >Product Information</h3>
        <h6 style="line-height:25px; text-align: justify;">Nippon Paint Vinilex 5000 Wall Sealer is an acrylic water-based wall sealer. It is easy to apply and promotes better build and adhesion to the substrate.
        </h6>
        <h4 class="mt-50">1.Nippon Vinilex 5000 Features</h4>
        <ul style="line-height:25px">
            <li>Good adhesion on recommended surfaces.</li>

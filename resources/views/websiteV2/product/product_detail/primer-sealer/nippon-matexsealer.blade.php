    ...
    <div class="center-body">
        <div class="row">
            ...
            <div class="col col-8">
                ...
                <h6 style="line-height:25px">Nippon Paint MATEX SEALER is a Water-based Protective & Decorative Paint environmentally friendly product that is
                ...
                <h4 class="mt-50">1.Nippon Matex Sealer Features</h4>
                ...
                <h4 class="mt-50">2.Application of Nippon Matex Sealer</h4>
                <ul style="line-height:25px">
...
<div id="lqd-contents-wrap" class="mobile-display">
    <div class="titlebar-inner-40">
        <div class="container titlebar-container">
            <div class="row titlebar-container justify-center">
                <div class="col titlebar-col col-xl-6 col-lg-8 col-12 text-center text-gray-400">
                    <h4 class="uppercase title-h6">Nippon Matex Sealer</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="" >
        <img src="{{ url('webv2/images/product/matexsealer.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint" class="mobile-center">
        <a href="/webv2/primer-sealer/matex-sealer-kh.pdf" download="Nippon Matex Sealer" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (KHM)
        </a>
        <a href="/webv2/primer-sealer/matex-sealer.pdf" download="Nippon Matex Sealer" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (ENG)
        </a>
    </div>
    <div class="mobile-center" style="width: 350px;">
        <h3 class="mt-50" >Product Information</h3>
        <h6 style="line-height:25px; text-align: justify;">Nippon Paint MATEX SEALER is a Water-based Protective & Decorative Paint environmentally friendly product that is
            suitable for masonry surfaces. It is formulated to achieve better adhesion and improve the
            deterioration of emulsion paints by strong concentration of cement chemicals.
        </h6>
        <h4 class="mt-50">1.Nippon Matex Sealer Features</h4>

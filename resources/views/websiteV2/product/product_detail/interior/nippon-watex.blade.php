...
<div id="lqd-contents-wrap" class="mobile-display">
        ...
        <div class="container titlebar-container">
            <div class="row titlebar-container justify-center">
                <div class="col titlebar-col col-xl-6 col-lg-8 col-12 text-center text-gray-400">
                    <h4 class="uppercase title-h6">Nippon Watex</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="" >
        <img src="{{ url('webv2/images/product/watex.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint" class="mobile-center">
        <a href="/webv2/interior/watex-kh.pdf" download="Nippon Watex" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (KHM)
        </a>
        <a href="/webv2/interior/watex-kh.pdf" download="Nippon Watex" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
    ...
    <div class="mobile-center" style="width: 350px;">
        <h3 class="mt-50" >Product Information</h3>
        <h6 style="line-height:25px; text-align: justify;">Nippon Watex Emulsion is a Vinyl Acrylic Copolymer emulsion paint which is specially formulated for economical needs. It has a smooth matt finish and is fungus resistant.
        </h6>
        <h4 class="mt-50">1.Nippon Watex Features</h4>
        <ul style="line-height:25px">
            <li>Economical.</li>

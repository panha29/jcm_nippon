    ...
    <div class="center-body">
        <div class="row">
            <div class="col col-4">
                ...
                <a href="/webv2/wood-metal/gold2000-kh.pdf" download="Nippon Gold Paint 2000" class="title-h1 a-btn btn-hover mt-10 title-h1">
                    <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
                    Technical Documentation (KHM)
                </a>
                <a href="/webv2/wood-metal/gold2000.pdf" download="Nippon Gold Paint 2000" class="title-h1 a-btn btn-hover mt-10 title-h1">
                    <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
...
<div id="lqd-contents-wrap" class="mobile-display">
        ...
        <div class="container titlebar-container">
            <div class="row titlebar-container justify-center">
                <div class="col titlebar-col col-xl-6 col-lg-8 col-12 text-center text-gray-400">
                    <h4 class="uppercase title-h6">Nippon Gold Paint 2000</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="" >
        <img src="{{ url('webv2/images/product/goldpaint2000.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint" class="mobile-center">
        <a href="/webv2/wood-metal/gold2000-kh.pdf" download="Nippon Gold Paint 2000" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (KHM)
        </a>
        <a href="/webv2/wood-metal/gold2000.pdf" download="Nippon Gold Paint 2000" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (ENG)
        </a>
    </div>
    <div class="mobile-center" style="width: 350px;">
        <h3 class="mt-50" >Product Information</h3>
        <h6 style="line-height:25px; text-align: justify;">Nippon Paint Gold Paint 2000 is formulated from special thermoplastic acrylic resin and gold pigments.
            It is suitable for both interior and exterior decoration.
            It give shine and gorgeous finishing. Excellent alkaline and efflorescence resistance with excellent adhesion.
        </h6>
        <h4 class="mt-50">1.Nippon Gold Paint 2000 Features</h4>

...
<div id="lqd-contents-wrap" class="pc-display">
    ...
    <div class="center-body">
        <div class="row">
            <div class="col col-4">
                <img src="{{ url('webv2/images/product/ZincPhosphatePrimer.png.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint">
...
<div id="lqd-contents-wrap" class="mobile-display">
        ...
        <div class="container titlebar-container">
            <div class="row titlebar-container justify-center">
                <div class="col titlebar-col col-xl-6 col-lg-8 col-12 text-center text-gray-400">
                    <h4 class="uppercase title-h6">Nippon Zinc Phosphate</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="" >
        <img src="{{ url('webv2/images/product/ZincPhosphatePrimer.png.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint" class="mobile-center">
        <a href="/webv2/wood-metal/zinc-phosphate-primer-kh.pdf" download="Nippon Zinc Phosphate" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (KHM)
        </a>
        <a href="/webv2/wood-metal/zinc-phosphate-primer.pdf" download="Nippon Zinc Phosphate" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (ENG)
        </a>
    </div>
    <div class="mobile-center" style="width: 350px;">
        <h3 class="mt-50" >Product Information</h3>
        <h6 style="line-height:25px; text-align: justify;">NIPPON ZINC PHOSPHATE BLAST PRIMER is a two-pack Epoxy-Amin anti-corrosive primer with non-toxic Zinc Phosphate as its pigment.
            It is recommended for use in combination with Nippon EA-4 Finish, Nippon EA-9 Finish and Nippon Polyurethane Finish for corrosive environment.
        </h6>
        <h4 class="mt-50">1.Nippon Zinc Phosphate Features</h4>
        <ul style="line-height:25px">
            <li>Resistant to splash, spillage and immersion in a wide range of chemicals, fresh water, etc.</li>
            <li>Excellent mechanical film properties such as Film Hardness, Adhesion, Scratch Resistance and AbrasionResistance.</li>
            <li>Easy application by brush, roller and spray.</li>
        </ul>
        <h4 class="mt-50">2.Application of Nippon Zinc Phosphate</h4>
        <ul style="line-height:25px">
            <li>Mild Steel Surfaces.</li>
            <li>Galvanised Steel Surface.</li>
            <li>Aluminium and Stainless Steel Surface.</li>

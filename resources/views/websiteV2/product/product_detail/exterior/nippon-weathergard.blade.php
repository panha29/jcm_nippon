    ...
    <div class="center-body">
        <div class="row">
            <div class="col col-4">
                ...
                <a href="/webv2/exterior/weathergard-kh.pdf" download="Nippon Weathergard" class="title-h1 a-btn btn-hover mt-10 title-h1">
                    <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
                    Technical Documentation (KHM)
                </a>
                <a href="/webv2/exterior/weathergard.pdf" download="Nippon Weathergard" class="title-h1 a-btn btn-hover mt-10 title-h1">
                    <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            ...
            <div class="col col-8">
                <h1 class="uppercase title-h1">Nippon WeatherGard</h1>
                <h4>EXTERIOR</h4>
                <h3 class="mt-50" >Product Information</h3>
                <h6 style="line-height:25px">Nippon WeatherGard is a high‐performance water‐based paint that possesses superior exterior durability
                    with water resistance and solar reflective properties.
                </h6>
                <h4 class="mt-50">1.Nippon WeatherGard Features</h4>
                <ul style="line-height:25px">
                    <li>Excellent weathering resistance and long lasting colour.</li>
                    <li>High solar energy reflection, less heat build‐up results in less power consumption for air‐conditioning
                        energy saving.</li>
                ...
                <h4 class="mt-50">2.Application of Nippon WeatherGard</h4>
                <ul style="line-height:25px">
...
<div id="lqd-contents-wrap" class="mobile-display">
    <div class="titlebar-inner-40">
        <div class="container titlebar-container">
            <div class="row titlebar-container justify-center">
                <div class="col titlebar-col col-xl-6 col-lg-8 col-12 text-center text-gray-400">
                    <h4 class="uppercase title-h6">Nippon WeatherGard</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="" >
        <img src="{{ url('webv2/images/product/weathergard6y.png') }}" alt="nippon paint cambodia ថ្មាំលាបផ្ទះ nippon paint" class="mobile-center">
        <a href="/webv2/exterior/weathergard-kh.pdf" download="Nippon Weathergard" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (KHM)
        </a>
        <a href="/webv2/exterior/weathergard.pdf" download="Nippon Weathergard" class="title-h1 a-btn-m btn-hover mt-10 title-h1 mobile-center">
            <img src="{{ url('webv2/images/icon-pdf-red.svg') }}" alt="" style="width: 40px">
            Technical Documentation (ENG)
        </a>
    </div>
    <div class="mobile-center" style="width: 350px;">
        <h3 class="mt-50" >Product Information</h3>
        <h6 style="line-height:25px; text-align: justify;">Nippon WeatherGard is a high‐performance water‐based paint that possesses superior exterior durability
            with water resistance and solar reflective properties.
        </h6>
        <h4 class="mt-50">1.Nippon WeatherGard Features</h4>
        <ul style="line-height:25px">

            ...
            <div class="col col-12 mb-30">
                <div class="lqd-tabs lqd-tabs-style-3 lqd-tabs-nav-items-not-expanded lqd-nav-underline-" data-tabs-options='{ "trigger" : "click" }'>
                    ...
                    <div class="lqd-tabs-content pt-15">
                        @include('websiteV2.product.product_listing')
                        @include('websiteV2.product.type.interior')
                        @include('websiteV2.product.type.exterior')
                        @include('websiteV2.product.type.primer-sealer')
                        @include('websiteV2.product.type.wood-metal')
                        @include('websiteV2.product.type.coating')
                    </div>
                </div>
            </div>
        </div>

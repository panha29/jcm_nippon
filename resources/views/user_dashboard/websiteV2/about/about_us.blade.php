        ...
        <div class="container" >
            ...
            <div class="row">
                ...
                <div class="col col-12 col-xl-6 p-0">
                    <div class="w-full relative flex items-center rounded-8 z-1 module-col p-20" data-parallax="true" data-parallax-options='{"ease":["linear"],"start":"top bottom","end":"bottom+=0px top"}' data-parallax-from='{"y":"60px"}' data-parallax-to='{"y":"-75px"}'>

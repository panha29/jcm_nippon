                    ...
                    <div class="col col-12 mb-30">
                        <div class="lqd-tabs lqd-tabs-style-3 lqd-tabs-nav-items-not-expanded lqd-nav-underline-" data-tabs-options='{ "trigger" : "click" }'>
                            <nav class="lqd-tabs-nav-wrap">
                                <ul class="reset-ul lqd-tabs-nav flex items-center justify-center border-black-10 link-17 uppercase font-ultrabold link-primary md:justify-between" role="tablist">
                                    ...
                                    <li data-controls="Nippon-Paint-Exterior" role="presentation" class="text-center">
                                        <a draggable="false" href="#Nippon-Paint-Exterior" class="active" aria-expanded="false" aria-controls="Nippon-Paint-Exterior" role="tab" data-bs-toggle="tab">
                                            <span class="iconbox items-center justify-center">
                                                <span class="flex flex-col">
                            ...
                            <div class="lqd-tabs-content pt-15">
                                @include('user_dashboard.websiteV2.product.nav_product.exterior.nav_product_listing')
                                @include('user_dashboard.websiteV2.product.nav_product.exterior.type.interior')
                                @include('user_dashboard.websiteV2.product.nav_product.exterior.type.exterior')
                                @include('user_dashboard.websiteV2.product.nav_product.exterior.type.primer-sealer')
                                @include('user_dashboard.websiteV2.product.nav_product.exterior.type.wood-metal')
                                @include('user_dashboard.websiteV2.product.nav_product.exterior.type.coating')
                            </div>
                        </div>
                    </div>
                </div>

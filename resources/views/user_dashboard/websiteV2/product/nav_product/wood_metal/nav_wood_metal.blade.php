                    ...
                    <div class="col col-12 mb-30">
                        <div class="lqd-tabs lqd-tabs-style-3 lqd-tabs-nav-items-not-expanded lqd-nav-underline-" data-tabs-options='{ "trigger" : "click" }'>
                            <nav class="lqd-tabs-nav-wrap">
                                <ul class="reset-ul lqd-tabs-nav flex items-center justify-center border-black-10 link-17 uppercase font-ultrabold link-primary md:justify-between" role="tablist">
                                    ...
                                    <li data-controls="Nippon-Paint-Interior" role="presentation" class="text-center">
                                        <a draggable="false" href="#Nippon-Paint-Interior" class="" aria-expanded="false" aria-controls="Nippon-Paint-Interior" role="tab" data-bs-toggle="tab">
                                            <span class="iconbox items-center justify-center">
                                                <span class="flex flex-col">
                                    ...
                                    <li data-controls="Nippon-Paint-Wood-Metal-Paint" role="presentation" class="text-center">
                                        <a draggable="false" href="#Nippon-Paint-Wood-Metal-Paint" class="active" aria-expanded="false" aria-controls="Nippon-Paint-Wood-Metal-Paint" role="tab" data-bs-toggle="tab">
                                            <span class="iconbox items-center justify-center">
                                                <span class="flex flex-col">
                            ...
                            <div class="lqd-tabs-content pt-15">
                                @include('user_dashboard.websiteV2.product.nav_product.wood_metal.nav_product_listing')
                                @include('user_dashboard.websiteV2.product.nav_product.wood_metal.type.interior')
                                @include('user_dashboard.websiteV2.product.nav_product.wood_metal.type.exterior')
                                @include('user_dashboard.websiteV2.product.nav_product.wood_metal.type.primer-sealer')
                                @include('user_dashboard.websiteV2.product.nav_product.wood_metal.type.wood-metal')
                                @include('user_dashboard.websiteV2.product.nav_product.wood_metal.type.coating')
                            </div>.
                        </div>
                    </div>
                </div>

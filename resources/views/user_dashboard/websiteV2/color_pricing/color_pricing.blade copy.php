                                    ...
                                    <div id="box">
                                        ...
                                        <span class="iconbox items-center justify-center mt-10">
                                            <span class="items-center justify-center uppercase font-ultrabold" style="text-align: center">
                                                <span class="leading-1/15em tracking-1"><b>Matex</b></span><br>
                                        ...
                                        <span class="iconbox items-center justify-center">
                                            <span class="items-center justify-center uppercase font-ultrabold" style="text-align: center">
                                                <span class="leading-1/15em tracking-1"><b>1L:{{number_format($item->color_1l,2)}}</b></span><br>
                                                <span class="leading-1/15em tracking-1"><b>5L:{{number_format($item->color_5l,2)}}</b></span><br>
                                                <span class="leading-1/15em tracking-1"><b>18L:{{number_format($item->color_18l,2)}}</b></span>
                                            </span>
                                        </span>

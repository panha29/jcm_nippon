<footer id="site-footer" class="main-footer bg-white text-blue-300">
    <!-- Start Subscribe -->
    <section class="lqd-section subscribe pt-60">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="flex flex-col py-10 pr-90 pl-10 mb-30 module-content">
                        ...
                        <ul class="icon-list-items inline-items flex flex-wrap list-none p-0 mb-0 -mx-10">
                            <li class="icon-list-item inline-item mx-10">
                                <a href="https://www.facebook.com/nipponcambodia" draggable="false" >
                                    <span class="icon-list-icon flex">
                                        {{-- <svg class="w-25 h-25" viewBox="0 0 512 512" style="color:rgba(0, 22, 52, 0.7);">
                                            <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
                                        </svg> --}}
                                        <i class='bx bxl-facebook-circle'  style="font-size:25px; color:rgba(0, 22, 52, 0.7);"></i>
                                    </span>
                                </a>
                                <span class="icon-list-text"></span>
                            </li>
                            <li class="icon-list-item inline-item mx-10">
                                <a href="https://www.instagram.com/nipponpaint.cambodia/" draggable="false">
                                    <span class="icon-list-icon flex">
                                        {{-- <svg class="w-25 h-25" viewBox="0 0 448 512" style="color:rgba(0, 22, 52, 0.7);">
                                        ...
                                        <i class='bx bxl-instagram' style="font-size:25px; color:rgba(0, 22, 52, 0.7);"></i>
                                    </span>
                                </a>
                                <span class="icon-list-text"></span>
                            </li>
                            <li class="icon-list-item inline-item mx-10">
                                <span class="icon-list-icon flex">
                                    <a href="https://t.me/jcmnp" draggable="false">
                                        <i class='bx bxl-telegram' style="font-size:25px; color:rgba(0, 22, 52, 0.7);" ></i>
                                    </a>
                                </span>
                                <span class="icon-list-text"></span>
                            </li>
                ...
                <div class="w-55percent flex p-0 lg:w-full">
                    <div class="w-full flex flex-wrap p-10 mb-30">
                        <div class="w-50percent sm:w-50percent">
                                ...
                                <div class="lqd-fancy-menu lqd-custom-menu relative lqd-menu-td-none">
                                    <ul class="reset-ul">
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/Project-Reference">Project Reference</a>
                                        </li>
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/Career">Careers</a>
                                        </li>
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/News">Press media</a>
                                        </li>
                                        <li class="w-full flex items-center">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/About-Us">More Information</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="w-50percent sm:w-50percent">
                            <div class="module-list flex flex-col justify-start mb-30 p-10">
                                ...
                                <div class="lqd-fancy-menu lqd-custom-menu relative lqd-menu-td-none">
                                    <ul class="reset-ul">
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/">Home</a>
                                        </li>
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/Products">Product</a>
                                        </li>
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/Painting-Services">Painting Services</a>
                                        </li>
                                        <li class="w-full flex items-center">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/User/Contact-Us">Contact Us</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="w-45percent relative flex flex-col sm:w-full">
                    <div class="lqd-contact-form lqd-contact-form-inputs-underlined lqd-contact-form-button-lg lqd-contact-form-button-block p-10">
                        <div role="form">
                            ...
                            <form action="/webv2/php/mailer.php" method="post" class="lqd-cf-form" novalidate="novalidate" data-status="init">
                                <div class="row">

<div class="nav-content d-flex">
    ...
    <div class="logo position-relative">
        <a href="/">
            ...
            {{-- <div class="img"></div> --}}
            <img src="../../img/logo/homefix-logo.png" alt="">
        </a>
    </div>
    <!-- Logo End -->
    ...
    <div class="menu-container flex-grow-1">
        <ul id="menu" class="menu nav">
            ...
            {{-- <li>
                <a href="#products" data-href="/Product">
                ...
                <ul id="products">
                    ...
                    <li>
                        <a href="/Product/Visual">
                            <span class="label">Visual</span>
                        </a>
                    </li>
                    <li>
                        <a href="/Product/Analytic">
            ...
            <li>
                <a href="#usercustomers" data-href="/User/Customers/List" draggable="false">
                    <i data-acorn-icon="book" class="icon" data-acorn-size="18"></i>
                    <span class="label">Customers</span>
                </a>
                <ul id="usercustomers">
                    <li>
                        <a href="/User/Customers/List" draggable="false">
                            <span class="label">Customer List</span>
                        </a>
                    </li>
                    <li>
                        <a href="/User/Customers/Index" draggable="false">
                            <span class="label">Customer Index</span>
                        </a>
                    </li>
                    <li>
                        <a href="/User/Customers/Information" draggable="false">

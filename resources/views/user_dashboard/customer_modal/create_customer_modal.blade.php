                ...
                <div class="modal fade" id="createcustomer" tabindex="-1" aria-labelledby="new_customer" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/User/Customers/dashboard-create-customer" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="customer_discount" placeholder="%">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="input-group mb-3">

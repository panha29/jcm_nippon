                                ...
                                <div class="lqd-fancy-menu lqd-custom-menu relative lqd-menu-td-none">
                                    <ul class="reset-ul">
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/Project-Reference">Project Reference</a>
                                        </li>
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/Career">Careers</a>
                                        </li>
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/News">Press media</a>
                                        </li>
                                        <li class="w-full flex items-center">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/About-Us">More Information</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="module-list flex flex-col justify-start mb-30 p-10">
                                ...
                                <div class="lqd-fancy-menu lqd-custom-menu relative lqd-menu-td-none">
                                    <ul class="reset-ul">
                                        ...
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/Products">Product</a>
                                        </li>
                                        <li class="w-full flex items-center mb-10">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/Painting-Services">Painting Services</a>
                                        </li>
                                        <li class="w-full flex items-center">
                                            <a class="w-full flex items-center leading-1/4em text-blue-400" href="/Contact-Us">Contact Us</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>

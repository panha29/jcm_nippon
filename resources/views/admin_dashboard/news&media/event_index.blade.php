            ...
            <div class="col-4">
                <div class="card mb-2">
                    <div class="card-body" id="saveform_error">
                        <h3 style="text-align: center" class="mb-3">Add Event</h3>
                        <form action="/Admin/News/Event/AddEvent" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="event_title" style="width: 100px;">Career Title</span>
                                <input type="text" class="form-control" placeholder="" aria-label="event_title" aria-describedby="event_title" name="event_title" autocomplete="off" id="event_title" >
                            </div>
                            {{-- <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3" >
                                <span class="input-group-text" id="event_date" style="width: 100px;">Date</span>
                                <input type="text" class="form-control" placeholder="" aria-label="event_date" aria-describedby="event_date" name="event_date" autocomplete="off" id="event_date">
                            </div>
                            <div class="input-group mb-3" >
                                <span class="input-group-text" id="event_detail" style="width: 100px;">Detail</span>
                                <input type="text" class="form-control" placeholder="" aria-label="event_detail" aria-describedby="event_detail" name="event_detail" autocomplete="off" id="event_detail">
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" name="event_image" id="input-file1" onchange="loadFile1(event)">
                            </div>
                            <div class="">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ url('img/product/company_product/'.$item->event_image) }}" alt="" style="width: 100px; height: 100px;" onerror="this.style.display = 'none'">
                                        </td>
                                        <td>
                                            {{$item->event_date}}
                                        </td>

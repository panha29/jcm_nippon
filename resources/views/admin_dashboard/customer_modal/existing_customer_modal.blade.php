                        ...
                        <tbody id="detailtbody">
                            @foreach ($detail as $item)
                                <tr class="existing mb-3">
                                    <td class="col-2" style="text-align: left">{{$item->customer_name}}</td>
                                    <td class="col-1" style="text-align: right">{{$item->customer_phone}}</td>
                                    ...
                                    <div class="modal fade" id="existing{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title addcs">បំពេញចន្លោះខាងក្រោម</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">

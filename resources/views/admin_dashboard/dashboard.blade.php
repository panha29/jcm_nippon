...
<div class="container">
        ...
        <div class="col-12">
            ...
            <div class="mb-5">
                <div class="row g-2">
                   ...
                   @include('admin_dashboard/count_customer')
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <a class="card h-100 hover-scale-up cursor-pointer" data-bs-toggle="modal" data-bs-target="#existingcustomer">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">
                                    ...
                                    <h2 draggable="false">បញ្ចូលទិន្ន័យ</h2>
                                </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-2" >
                        <a draggable="false" class="card h-100 hover-scale-up cursor-pointer" draggable="false" data-bs-toggle="modal" data-bs-target="#createcustomer">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                    <i data-acorn-icon="message" class="text-primary"></i>
                                </div>
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">
                                    <h2 draggable="false">បង្កើតអតិថិជនថ្មី</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    {{-- @include('admin_dashboard/customer_modal/create_customer_modal')
                    @include('admin_dashboard/customer_modal/existing_customer_modal') --}}
                </div>
            </div>
        </div>
    </div>
    ...
    @include('admin_dashboard/recent_order')

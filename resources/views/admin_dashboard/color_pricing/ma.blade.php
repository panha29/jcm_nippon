            ...
            <div class="col">
                <div class="card-body">
                    <div class="input-group">
                        <form action="/Admin/ColorPricing/List/ImportMa" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <tbody>
                        @foreach ($ma as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/Admin/ColorPricing/Matex/{{$item->id}}/Delete" class="btn btn-danger" draggable="false">Delete</a>
                                    <a href="/Admin/ColorPricing/Matex/{{$item->id}}/Edit" class="btn btn-primary" draggable="false">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>

        ...
        <div class="row mb-3">
            <div class="col">
                <div class="card-body">
                    <div class="input-group">
                        <form action="/Admin/ColorPricing/List/ImportWb" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="col">
                <div style="float: right">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#weatherbond" >
                        Add Color
                    </button>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($wb as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/Admin/ColorPricing/WeatherBond/{{$item->id}}/Delete" class="btn btn-danger" draggable="false">Delete</a>
                                    <a href="/Admin/ColorPricing/WeatherBond/{{$item->id}}/Edit" class="btn btn-primary" draggable="false">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>

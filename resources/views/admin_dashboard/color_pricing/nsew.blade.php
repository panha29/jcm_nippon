        ...
        <div class="row mb-3">
            <div class="col">
                <div class="card-body">
                    <div class="input-group">
                        <form action="/Admin/ColorPricing/List/ImportNsew" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="col">
                <div style="float: right">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#supereasywash" >
                        Add Color
                    </button>
                </div>
            </div>

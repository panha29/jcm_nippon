                    ...
                    <tbody>
                        @foreach ($mpm as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/Admin/ColorPricing/Premium-Matex/{{$item->id}}/Delete" class="btn btn-danger" draggable="false">Delete</a>
                                    <a href="/Admin/ColorPricing/Premium-Matex/{{$item->id}}/Edit" class="btn btn-primary" draggable="false">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>

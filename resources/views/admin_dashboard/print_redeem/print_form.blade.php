<html>
    ...
    @include('admin_dashboard/print_redeem/print_css')
    @include('admin_dashboard/print_redeem/print_js')
<style>
.font{
...
<body>
    ...
    <label class="label" style="font-weight:bold"><b>Mao Tse Toung Boulevard 245, Phnom Penh</b></label><br>

        <h1>reciept</h1>
        @include('admin_dashboard/print_redeem/print_info')
    </header>
    <article>

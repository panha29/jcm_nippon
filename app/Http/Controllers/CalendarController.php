...
class CalendarController extends Controller
{
    public function index()
    {
        ...
        return view('admin-view.calendar.index', compact('events','orderdate','arrivingdate','testingdate'));
    ...
    public function bookingdate(){
        ...
        return view('admin-view.calendar.booking-date',compact('bkdate'));
    }
    ...
    public function delete($id){
        ...
        return redirect('Admin/Calendar/Booking');
    }

    function edit($id){
        $data = Booking::find($id);
        return view('admin-view.calendar.edit_form_modal',compact('data'));
    }
    ...
    function project_index(){
        return view('admin-view.calendar.project');
    }
}
